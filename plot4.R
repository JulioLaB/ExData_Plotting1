...
#plot the first ones
plot(mydays$Date,mydays$Global_active_power, 
...
legend("topright",c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),
       lty=1, col=c("black","red","blue"), bty = "n") #note that I omit the border of the legen

#plot the third one
plot(mydays$Date,mydays$Voltage, 
     type = "l", ylab = "Voltage", xlab="datetime")

#and the last one
plot(mydays$Date,mydays$Global_reactive_power, 
